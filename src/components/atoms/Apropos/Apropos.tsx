...
export const Apropos = () => {
  return (
    <div className="bg-transparent pb-16 pt-24 sm:pb-0 sm:pt-32 ">
            ...
            <div className="relative isolate pt-6 sm:pt-12">
              ...
              <div className="text-xl/8 font-semibold text-white sm:text-2xl/9">
                ...
                <FancyText
                  ...
                  className="pb-4 text-[30px]"
                >
                  Snowpact
                </FancyText>
                <p className="italic">
                  Notre mission est de vous accompagner dans la conception, le
                  développement et le déploiement de vos applications web et
                  mobile, en utilisant la méthode agile pour garantir la
                  qualité, la flexibilité et la satisfaction de vos besoins.
                </p>
              </div>
