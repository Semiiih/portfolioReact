...
import bilanHero from "@/assets/macbookScroll.png";
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:min-h-[120vh] md:scale-100 md:py-0"
    >
      <motion.h2
        style={{
        ...
        {title || (
          <span>
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Deux années d'apprentissage, de défis et de croissance personnelle
              et professionnelle
            </p>
          </span>
        )}
        ...
        >
          <span className="text-white">
            <img
              src={avataaars2}
              alt="aceternity logo"
              className="w absolute inset-0 h-10 w-10 self-center justify-self-center rounded-lg   text-white "
            />
          </span>
        </div>
      </div>
