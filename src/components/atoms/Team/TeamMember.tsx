...
export const TeamMember = ({
  ...
  return (
    <div
      className={`border-primary-500/50 shadow-primary-500/50 m-2 grid min-h-[200px] w-40 items-center justify-items-center rounded-xl border bg-white p-3 text-center shadow-[0px_3px_0px_0px]  md:w-40 ${
        stylePerso
