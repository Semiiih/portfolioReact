...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "absolute  z-0 flex min-h-screen w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-950 ",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center pb-96 ">
        <motion.div
