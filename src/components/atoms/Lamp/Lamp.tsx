...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "absolute  z-0 flex min-h-screen w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-900 pl-[800px]",
        className,
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center pb-32  ">
        <motion.div
      ...
      <div className="relative z-50 flex -translate-y-[800px] flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
